...
def init_database():
    ...
    sent = Sent(user_id =1,send_date="",status="",subject="warming up", content= "bagi-bagi uang",device="email",contact_id=1, group_id=1,open_rate=1,click_rate=1,total_sent=1)
    db.session.add(sent)
    db.session.commit()
